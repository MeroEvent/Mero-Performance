    ...
    <DashboardShell>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-1">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors self-start sm:self-auto cursor-pointer shadow-xs"
        >
                  ...
                  paginatedLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                          {log.entity_type}
                        </span>
                      </td>
                      ...
                      <td className="py-3.5 px-4">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-wider border ${
                            log.action === 'override'
                      ...
                      <td className="py-3.5 px-5 text-right font-mono text-xs">
                        <details className="cursor-pointer inline-block text-left">
                          <summary className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-sans font-bold text-xs select-none">
                            Inspect Diff
                          </summary>
