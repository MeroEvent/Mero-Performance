          ...
          {activeTab === 'month' ? (
            <>
                    ...
                    <button
                      ...
                      className={`py-2.5 px-3 rounded-2xl text-xs font-bold transition-all cursor-pointer text-center relative ${
                        isSelected
                          ...
                          : isCurrent
                          ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-600 font-bold'
              ...
              <div className="flex items-center justify-between pt-3 mt-3 border-t border-slate-100 dark:border-slate-800/80">
                <button
                  ...
                  className="text-[11px] font-bold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white cursor-pointer"
                >
            ...
            <form onSubmit={handleApplyCustomRange} className="space-y-3 py-1">
              ...
              <div className="pt-2 flex items-center justify-between gap-2 border-t border-slate-100 dark:border-slate-800/80">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-xl text-xs font-bold hover:bg-slate-800 dark:hover:bg-slate-100 shadow-xs cursor-pointer active:scale-95 transition-all"
                >
